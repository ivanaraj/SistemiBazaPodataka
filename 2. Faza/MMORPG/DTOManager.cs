...
//        public static async Task<IgracBasic> vratiIgraca(int id)
//        {
...
//                if (s != null)
//                {
//                    Igrac igrac = await s.LoadAsync<Igrac>(id);

//                    igracBasic = new IgracBasic(igrac.Id, igrac.Nadimak, igrac.Lozinka,
//                        igrac.Ime, igrac.Prezime, igrac.Pol, igrac.Uzrast);
//                }
//            }
//            catch (Exception ec)
//            {
...
//        //        MMORPG.Entities.Igrac igracEntity = s.Load<MMORPG.Entities.Igrac>(id);

//        //        // 2. Map the entity's simple properties to the DTO.
//        //        igracBasic.Id = igracEntity.Id;
//        //        igracBasic.Nadimak = igracEntity.Nadimak;
//        //        igracBasic.Lozinka = igracEntity.Lozinka;
//        //        igracBasic.Ime = igracEntity.Ime;
//        //        igracBasic.Prezime = igracEntity.Prezime;
//        //        igracBasic.Pol = igracEntity.Pol;
//        //        igracBasic.Uzrast = igracEntity.Uzrast;

//        //        // 3. Map the referenced Tim entity to a TimPregled DTO.
//        //        if (igracEntity.Tim != null)
//        //        {
//        //            igracBasic.Tim = new TimPregled(
//        //                igracEntity.Tim.Naziv,
//        //                igracEntity.Tim.MaxIgraca,
//        //                igracEntity.Tim.MinIgraca,
//        //                igracEntity.Tim.BonusPoeni
//        //            );
//        //        }

//        //        // 4. Force collections to load and map them to collections of DTOs.
//        //        // This is the key part of the fix. Iterating the collections forces lazy-loading
//        //        // while the session is still open.

//        //        foreach (var sesija in igracEntity.Sesije)
//        //        {
//        //            igracBasic.Sesije.Add(new SesijaPregled(sesija.Id, sesija.VremePocetka, sesija.VremeTrajanja, sesija.Igrac));
//        //        }

//        //        foreach (var lik in igracEntity.Likovi)
//        //        {
//        //            igracBasic.Likovi.Add(new LikPregled(lik.Id, lik.StepenZamora, lik.Iskustvo, lik.KolicinaZlata, lik.NivoZdravstvenogStanja, lik.Rasa, lik.Klasa, lik.Igrac));
//        //        }

//        //        foreach (var pomocnik in igracEntity.Pomocnici)
//        //        {
//        //            igracBasic.Pomocnici.Add(new PomocnikPregled(pomocnik.Id, pomocnik.Igrac, pomocnik.Ime, pomocnik.BonusZastite, pomocnik.NazivRase, pomocnik.NazivKlase));
//        //        }

//        //        foreach (var predmet in igracEntity.KljučniPredmeti)
//        //        {
//        //            igracBasic.KljučniPredmeti.Add(new PredmetPregled(predmet.Id, predmet.Naziv, predmet.Opis));
//        //        }

//        //        foreach (var oprema in igracEntity.Opreme)
//        //        {
//        //            igracBasic.Opreme.Add(new OpremaPregled(oprema.Id, oprema.Naziv, oprema.TipOpreme, oprema.XpBonus));
//        //        }
//        //        s.Close();
//        //    }
//        //    catch (Exception ec)
...
//                throw new Exception("Niste uspeli da obrisete Igraca!");
